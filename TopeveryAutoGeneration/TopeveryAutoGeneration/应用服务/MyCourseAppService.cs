...
namespace ZF.Application.AppService
{
    ...
    /// </summary>
    public class MyCourseAppService : BaseAppService<MyCourse>
    {
	   ...
	   public MyCourseAppService(IMyCourseRepository iMyCourseRepository,OperatorLogAppService operatorLogAppService): base(iMyCourseRepository)
	   {
