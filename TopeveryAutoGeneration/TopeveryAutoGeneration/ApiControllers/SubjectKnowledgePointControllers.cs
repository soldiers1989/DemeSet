...
namespace ZF.Web.ApiControllers
{
    ...
    public class SubjectKnowledgePointController : BaseController
    {
	   ...
	   /// <summary>
            ...
            foreach (var item in array)
            {
                ...
                if (model != null)
				{
                    _operatorLogAppService.Add(new OperatorLogInput
                    {
                        ...
                        Remark = "删除SubjectKnowledgePoint:"
                    });
				}
                _subjectKnowledgePointAppService.Delete(model);
            }
        ...
        public SubjectKnowledgePoint GetOne(IdInput input)
        {
            var model = _subjectKnowledgePointAppService.Get(input.Id);
            return model;
        }
    }
}
