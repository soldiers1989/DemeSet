...
{
    /// <summary>
    /// 数据表映射实体类：SubjectBigQuestion 
    /// </summary>
    public sealed class SubjectBigQuestionMap : FullAuditEntityClassMapper<SubjectBigQuestion, Guid>
    {
		public SubjectBigQuestionMap ()
		{
			Table("t_Subject_BigQuestion");
			...
			Map(x => x.SubjectClassId).Column("SubjectClassId");
			...
			Map(x => x.UseTimes).Column("UseTimes");
