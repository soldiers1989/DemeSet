...
namespace ZF.Web.ApiControllers
{
    ...
    public class CourseResourceController : BaseController
    {
	   ...
	   /// <summary>
            ...
            foreach (var item in array)
            {
                ...
                if (model != null)
				{
                    _operatorLogAppService.Add(new OperatorLogInput
                    {
                        ...
                        Remark = string.Format("删除课程资源:{0}-{1}",model.CourseId,model.ResourceName)
                    });
				}
        ...
        {
            var fileSize = AliyunFileUpdata.GetFileDate(input.IdFilehiddenFile);
            input.ResourceSize = ( fileSize / 1024 / 1024 ) > 0 ? ( fileSize / 1024 / 1024 + "M" ) : ( fileSize / 1024 ) > 0 ? ( fileSize / 1024 + "K" ) : fileSize + "B";
