$(function () {
    ...
    var getPostDataUrl = "api/OrderSheet/GetSalesReportsDayList";
    var grid = $("#tblData");
    grid.jgridInit({
        url: getPostDataUrl,
        colNames: ['序号', '日期', '笔数', '金额（元）',''],//列头
        colModel: [
    ...
    function GraphicReport() {
        topevery.ajax({
            type: "Post",
            url: "api/OrderSheet/GetSalesReportsDayList",
    ...
    $(".import_btn").bindExportBtn("OrderSheet/ExportDay");
});