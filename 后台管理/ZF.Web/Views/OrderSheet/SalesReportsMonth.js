$(function () {
    ...
    var getPostDataUrl = "api/OrderSheet/GetSalesReportsMonthList";
    var grid = $("#tblData");
    grid.jgridInit({
        url: getPostDataUrl,
        colNames: ['序号', '月份', '笔数', '金额（元）', ''], //列头
        colModel: [
    ...
    function GraphicReport() {
        topevery.ajax({
            type: "Post",
            url: "api/OrderSheet/GetSalesReportsMonthList",
    ...
    $(".import_btn").bindExportBtn("OrderSheet/ExportMonth");
});