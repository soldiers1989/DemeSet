var Content = UE.getEditor('Content', { enterTag: 'br' });
///初始化
$(function () {
    var addorEditUrl = 'api/UseDescription/AddOrEdit';
    topevery.BindSelect("BigClassId", "Common/GetBigClassIdList?Code=zllb", "--请选择--", Initialize);
    function Initialize() {
        ///初始化From表单以及验证信息
        if ($("#Id").val()) {
            topevery.ajax({
                url: "api/UseDescription/GetOne",
    ...
    $(".return").bindAddSkip("UseDescription/Index");
    /**
     * 绑定验证规则
     */
