$(function () {
    ...
    grid.jgridInit({
        ...
        colModel: [
            ...
            { name: 'DataTypeName', index: 'DataTypeName', width: 70, align: "center" },
            { name: 'Name', index: '', width: 70, align: "center" },
    ...
    ///获取所属列表
    topevery.BindSelect("QueryBigClassId", "Common/GetBigClassIdList?Code=bzgl", "--全部--");
