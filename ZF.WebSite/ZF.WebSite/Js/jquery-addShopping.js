        ...
        shoping: function (options) {
            ...
            var S = {
                ...
                addIcon: function () {
                    ...
                    var icon = '<div id="cartIcon" style="width:30px;height:30px;padding:2px; border:solid 0px #e54144;overflow:hidden;position:absolute;z-index:890;' + $options.iconCSS + '"><img src="' + $options.iconImg + '" width="30" height="30" /></div>';
                    return icon;
                }
            };
            S.init();
