...
function addAddress() {
    ...
    topevery.ajaxwx({
        ...
        if (info.Success) {
            ...
            if (hiparament && wxJsApiParam) {
                window.location.href = "/jjs/PersonalCenter/MyPay?hiparament=" + hiparament + "&wxJsApiParam=" + wxJsApiParam + "&type=hand";
            }
        }
    });
}
...
function showError(type) {
    switch (type) {
        case 1:
            $("#consigneeAddressNote").html("收件人不能为空");
            break;
        case 2:
