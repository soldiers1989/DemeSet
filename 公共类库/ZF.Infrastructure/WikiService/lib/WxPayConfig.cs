...
namespace ZF.Infrastructure.WikiService.lib
{
    /**
    * 	配置账号信息
    */
    public class WxPayConfig
    {
        ...
        */
        ...
        //=======【支付结果通知url】===================================== 
        /* 支付结果通知回调url，用于商户接收支付结果http://zgrskspx.class.com.cn/jjs/HomePage/Index
        */
        public const string NOTIFY_URL = "http://zgrskspx.class.com.cn/Cart/WxPayResultNotifyPage";
