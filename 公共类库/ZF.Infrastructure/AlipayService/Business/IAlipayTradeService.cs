...
namespace ZF.Infrastructure.AlipayService.Business
{
    ...
    public interface IAlipayTradeService
    {
        ...
        //电脑网站支付
        AlipayTradePagePayResult tradePage(AlipayTradePageContentBuilder builder);

        AlipayTradePagePayResult tradePage(AlipayTradePageContentBuilder builder, string notify_url);

        //删除订单
        AlipayTradeClosePayResult tradeClose(AlipayTradeCloseContentBuilder builder);
    }
}
