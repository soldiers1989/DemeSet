...
namespace ZF.Infrastructure.AlipayService.Business
{
    ...
    public class AlipayTradeImpl : IAlipayTradeService
    {
        ...
        private static string returnUrl = ConfigurationManager.AppSettings["RETURN_URL"];
     ...
     string sign_type, string alipay_public_key, string charset)
        ...
        /// <returns></returns>
        public AlipayTradePagePayResult tradePage(AlipayTradePageContentBuilder builder)
        {
            AlipayTradePagePayResult request = new AlipayTradePagePayResult();
            try
            {
                AlipayTradePagePayRequest payRequest = new AlipayTradePagePayRequest();
                payRequest.BizContent = builder.BuildJson();
                payRequest.SetReturnUrl(returnUrl);
                request.response = client.pageExecute(payRequest);
                return request;
            }
            catch (Exception)
            {
        ...
        /// <returns></returns>
        public AlipayTradePagePayResult tradePage(AlipayTradePageContentBuilder builder, string notify_url)
        {
            AlipayTradePagePayResult request = new AlipayTradePagePayResult();
            try
            {
        ...
        /// <param name="builder"></param>
        /// <returns></returns>
        public AlipayTradeClosePayResult tradeClose(AlipayTradeCloseContentBuilder builder)
        {
            AlipayTradeClosePayResult result = new AlipayTradeClosePayResult();
            try
            {
                AlipayTradeCloseRequest request = new AlipayTradeCloseRequest();
                request.BizContent = builder.BuildJson();
                result.response = client.Execute(request);
                return result;
            }
            catch (Exception)
            {
