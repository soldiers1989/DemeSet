...
*/
    ...
    */
    ...
    function initConfig(opt) {
        _tileSize = [329, 329];
        _extent = [73452.19451233148, -8110.2989215552061, 183765.19611266855, 67103.111260492791];
        //[73452.19451233148, -2621.123242842993, 183765.19611266858, 61613.935581780577];
        //[73452.19451233148, -7346.412724393769, 183765.19611266858, 66339.22506333138];
...
//goog.inherits(TyMapUtils.Icon, TyMapUtils.Overlayex);
...
goog.inherits(TyMapUtils.Label, TyMapUtils.Overlayex);
...
goog.inherits(TyMapUtils.Marker, TyMapUtils.Overlayex);
...
goog.inherits(TyMapUtils.Popup, TyMapUtils.Overlayex);
...
goog.inherits(TyMapUtils.ScaleLine, ol.control.Control);
...
goog.inherits(TyMapUtils.SelectEvent, ol.events.Event);
...
goog.inherits(TyMapUtils.PointerMove, ol.interaction.Pointer);
...
goog.inherits(TyMapUtils.SingleSelect, ol.interaction.Interaction);
